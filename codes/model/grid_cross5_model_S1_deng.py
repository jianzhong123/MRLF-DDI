...
from model.gridsearch_deng_SEmodel import SE_GNN
...
class model_S0(torch.nn.Module):
    def __init__(self,device,index,dim,l,c):#in_dim,hidden_dim,out_dim,
        ...
        pub_path = '../data/drugfeatures/pubchem_fingerprint_DDIMDL.npy'
        ...
        alignn_path = '../data/drugfeatures/S1_alignn_DDIMDL_emb'+str(index)+'.npy'  #
    ...
    def forward(self, drug1s,drug2s, graph,simdrug1s,simdrug2s):
        ...
        #drug1_emb = modalfeatures1[drug1s.long()]
        #drug2_emb = modalfeatures1[drug2s.long()]
        ...
        drug1_global_emb =  drug1_emb + (1 - gate_weight1) * drug1_global_emb#gate_weight1 *
        drug2_global_emb = drug2_emb + (1 - gate_weight2) * drug2_global_emb#gate_weight2 *
