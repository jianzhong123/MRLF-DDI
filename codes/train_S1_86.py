...
from model.modelmlp_S1_86 import model_S0
...
def train(model, train_data_loader, val_data_loader, test_data_loader,loss_fn,  optimizer, n_epochs, device,morgen,alignn,mol,pub,features, scheduler=None):
    ...
    for i in range(1, n_epochs+1):
        ...
        for batch in train_data_loader:
            ...
            outs,autoloss,_=model(features,drug1s, drug2s,graph,drug1s, drug2s)
        ...
        with torch.no_grad():
            ...
            for batch in val_data_loader:
                ...
                outs,autoloss,all_emb= model(features, drug1s,drug2s, graph,simdrug1s,simdrug2s)
            ...
            if val_precision > best_acc:
                ...
                torch.save(model.state_dict(), 'label86_S2_best.pt')
                print('model saved')
            ...
            for batch in test_data_loader:
                ...
                drug1s, drug2s, labels,simdrug1s,simdrug2s  = batch
                outs,_,_ = model(features,drug1s, drug2s, graph,simdrug1s,simdrug2s)
...
if __name__ == '__main__':
    ...
    def run_model():#params
        ...
        df_ddi_val = pd.read_csv('../data/86datasets/S1_drug1559_similar_valid86.csv',header=0)
        ...
        df_ddi_test = pd.read_csv('../data/86datasets/S1_drug1559_similar_test86.csv', header=0)
        ...
        model = model_S0().to(device=device)
        ...
        train(model, train_data_loader, val_data_loader,test_data_loader, loss, optimizer, n_epochs, device,morgen,alignn,mol,pub,features,scheduler)
